//[akt](../../../index.md)/[dev.shanty.akt.actor.manager](../index.md)/[NoActorManagerRegisteredException](index.md)

# NoActorManagerRegisteredException

[jvm]\
class [NoActorManagerRegisteredException](index.md) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)

## Constructors

| | |
|---|---|
| [NoActorManagerRegisteredException](-no-actor-manager-registered-exception.md) | [jvm]<br>fun [NoActorManagerRegisteredException](-no-actor-manager-registered-exception.md)() |
